...
**Cybersecurity:**  
• Identity and Access Management • Network Security • Risk Management • Incident Response • Threat Detection

**Cloud Technologies:**  
• AWS • EC2 • S3 • Lambda • DynamoDB • API Gateway • VPC • Terraform

**Web Development:**  
• HTML • CSS • ReactJS • Node.js • Bootstrap • Streamlit
